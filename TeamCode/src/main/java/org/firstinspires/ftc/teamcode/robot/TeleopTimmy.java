            ...
            switch (currentState) {
                ...
                case RAMPING:
                    ...
                    if (getRuntime() > rampUpTimer) {//tests to see if 2 seconds have passed (remember the value of the variable rampUpTimer is 2
                        ...
                        carouselTimmy.setHomePositionKicker();//sets the kicker position to the home position (down)
                        stepStartTime = getRuntime();//increases the launch step by 1
                    }
                    break;
                ...
                case LAUNCHING:
                    switch (launchStep) {
                        ...
                        case 0:
                            if (getRuntime() - stepStartTime > launchStepDelay) {//creates a delay equal to the value of the variable launchStepDelay
                                carouselTimmy.spinCarouselLaunchOne();//rotates the carousel to the first launch position
                        ...
                        case 1:
                            if (getRuntime() - stepStartTime > launchStepDelay + .2) {//creates a delay, we added .2 seconds to the delay
                                carouselTimmy.setTinyKicker();//lifts the kicker a tiny bit to clear the well
                                stepStartTime = getRuntime();//resets the timer
                                launchStep++;//increases the launch step
                            }
                            break;
                        ...
                        // STEP 2 — tilt shooter
                        case 2:
                            if (getRuntime() - stepStartTime > launchStepDelay) {//TODO: remove the word false and insert the condition to test -hint: if (getRuntime() - stepStartTime > launchStepDelay)
                               shooterTimmy.setTiltPosition(tiltPosition); //TODO: set the tilt position -hint: shooterTimmy.setTiltPosition(tiltPosition);
                                stepStartTime = getRuntime();//resets the timer
                                launchStep++;//increases the launch step //TODO: reset the timer -hint: stepStartTime = getRuntime();
                        ...
                        case 4:
                            if (getRuntime() - stepStartTime > launchStepDelay) {//TODO: remove the word false and insert the condition to test
                                shooterTimmy.setHomeTiltPosition();//TODO: set the tilt position to the home position
                                stepStartTime = getRuntime();//resets the timer
                                launchStep++;//increases the launch step  //TODO: reset the timer
                                //TODO: increase the launchStep
                            }
                        ...
                        case 5:
                            if (getRuntime() - stepStartTime > launchStepDelay) {//TODO: remove the word false and insert the condition to test
                                carouselTimmy.setHomePositionKicker();//TODO: set the kicker to the home positon
                                stepStartTime = getRuntime();//resets the timer
                                launchStep++;//increases the launch step  //TODO: reset the timer
                                //TODO: increase the launchStep
                            }
