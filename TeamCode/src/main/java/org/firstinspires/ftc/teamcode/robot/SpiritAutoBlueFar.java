/*
This class is to be used if the goal is blue and the shot is from the back wall. It executes the launch sequence, and
drives the robot forward off of the tape (by time), At start, the robot must be placed at an angle on the back wall
