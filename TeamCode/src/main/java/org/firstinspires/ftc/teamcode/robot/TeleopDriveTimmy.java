...
public class TeleopDriveTimmy extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // ---------------------------------------------------------------
            double drive = gamepad1.left_stick_y; //TODO: create a variable of the type double, and store the input from gamepad1.left_stick_y;   // Forward / Backward
            double strafe = gamepad1.left_stick_x;//TODO: create a variable of the type double, and store the input from gamepad1.left_stick_x;   // Left / Right (strafe)
